...
export const CardWithForm: React.FC<CardContent> = ({
  ...
  return (
    <div className="relative grid h-[40rem] w-full max-w-[28rem] flex items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700 my-3">
      <div
      ...
      <div className="relative p-6 px-6 py-14 md:px-12">
        ...
        <button className="btn relative inline-flex items-center justify-start overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
          ...
          <a
            href={link}
            target="_blank"
            className="relative w-full text-left text-black transition-colors duration-300 ease-in-out group-hover:text-black p-2"
          >
            Daftar Sekarang
          </a>
        </button>
